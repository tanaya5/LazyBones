<%-- 
    Document   : UserPanel
    Created on : 13 May, 2017, 8:16:52 AM
    Author     : SURUCHI
--%>
    ...
    <body>
       ...
       <!-- <div id="mySidenav" class="sidenav">
        <div class="adm-lnk">
            ...
            <a class="active" href="#"><span class="icn"> <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="25px" width="25px"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-2 col-lg-2 col-sm-2 col-xs-12">
                    <div class="date">
                        <p>10/02/2016 - 11/02/2017  <i class="fa fa-caret-down" aria-hidden="true" style="color:#fff;"></i></p>
                    </div>
                </div>-->
                <ul >
                     <div  class="rightsidenav">
                        ...
                        <ul class="full-nav">
                            <li><a href="UserPanel.jsp">Dashboard</a>
                            </li>
                            <li><a href="Home.jsp">Log Out</a>
                            </li>
	...
	C42.677,47.979,42.567,48.054,42.459,48.132z" />
                            ...
                            <div class="admin-lnks">
                                <ul>
                                    ...
                                    <br><br><li> 
                                        <label style="color: white; font-size: 25px;">FeedBack</label><br><br>
                                
                                    <%
                                        if(objbean.getLike_dislike()==null)
                                        {
                                    %>
                                    <button style="width:40%;" onclick='checklike("like")'><img src="like.jpg" width="43px" height="40px"></button>&nbsp;
                                    <button style="width:40%;" onclick="checklike('dislike')"><img src="dislike.png" width="43px" height="40px"></button>
                                    <%
                                        }
                                        else if(objbean.getLike_dislike().equalsIgnoreCase("like"))
                                        {
                                    %>
                                    <button style="width:40%;" onclick="checklike('like')"><img src="liked.png" width="43px" height="40px"></button>&nbsp;
                                    <button style="width:40%;"onclick="checklike('dislike')"><img src="dislike.png" width="43px" height="40px"></button>
                                    <%
                                       }
                                    ...
                                    %>
                                    <button style="width:40%;" onclick="checklike('like')"><img src="like.jpg" width="43px" height="40px"></button>&nbsp;
                                    <button style="width:40%;"onclick="checklike('dislike')"><img src="disliked.png" width="43px" height="40px"></button>
                                    <%
                                      }
                                    %>
    ...
    <section class="main">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="main-lst" style="padding-left: 215px">
                        <div style="float :left ; width:30% ; height: 100%; display: inline-block" class="round-button" >
                <a href="Summarize.jsp" class="round-button-circle" style="display:inline-block;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Summarize&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                <a href="EditProfile.jsp" class="round-button-circle" style="display:inline-block;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Edit profile&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                <a href="ActivityLog.jsp" class="round-button-circle" style="display:inline-block;">&nbsp;&nbsp;&nbsp;&nbsp;Activity Log&nbsp;&nbsp;&nbsp;&nbsp;</a>
            </div>
        </div>
                    <div id="right"  >
            <div style="float :right ; width:65% ; height: 100%; display: inline-block" class="round-button" >
                <a href="UserComment.jsp" class="round-button-circle" style="display:inline-block;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Comment&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                <a href="ViewProfile.jsp" class="round-button-circle" style="display:inline-block;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;View Profile&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                <a href="ChangePassword.jsp" class="round-button-circle" style="display:inline-block;">Change Password</a>
            </div>
        </div>
         <%
             }
...
// When the user clicks on div, open the popup
            ...
            function checklike(ld)
            {
              var url="likedislike?ld="+ld;
