<%-- 
    Document   : ManageUser
    Created on : 14 May, 2017, 12:31:59 AM
    Author     : SURUCHI
--%>
    ...
    <section class="manage-user-table">
        <div style="padding-left: 300px;">
            ...
            <tr>
                ...
                {
                %>
                <td><%= objbean.getType()%>   <a href="ChangeUserType?userid=<%=objbean.getUserid()%>&pg=<%=pg%>"><img src="admin.png" width="20px" height="20px"></a></td>
                <%
                 }
                else
                {
                %>
                <td><%= objbean.getType()%>   <a href="ChangeUserType?userid=<%=objbean.getUserid()%>&pg=<%=pg%>"><img src="user.png" width="20px" height="20px"></a></td>
                <%
                }
                    if (objbean.isStatus()) {
                %>
                <td>Active  <a href="ActiveInactive?userid=<%=objbean.getUserid()%>&pg=<%=pg%>"><img src="c.jpg" width="20px" height="20px"></a></td>
                <%
                } else {
                %>
                <td>Inactive <a href="ActiveInactive?userid=<%=objbean.getUserid()%>&pg=<%=pg%>"><img src="T.jpg" width="20px" height="20px"></a></td>
                <%
                    }
                %>
                <td><%= objbean.getSignup()%></td>
