<%-- 
    Document   : AdminPanel
    Created on : May 13, 2017, 5:06:48 PM
    Author     : SURUCHI
--%>
	...
	C42.677,47.979,42.567,48.054,42.459,48.132z" />
        ...
        %>
                            ...
                            <div class="admin-lnks">
                                <ul>
                                    <li style="color: white"><%=objbean.getType()%>
                                    </li>
                                    <li style="color: white"><%=objbean.getEmail()%>
                                    </li>
                ...
                <div class="col-md-10">
                    <div class="main-lst">
                        <ul>
                            <li class="blue">
                                <h4>Total Users</h4>
                                <h1>  <%= UserMaintenanceServices.numberOfRegisteredUsers()+UserMaintenanceServices.numberOfGuestUsers()%></h1>
                            </li>
                            <li class="red">
                                <h4>Active Users</h4>
                                <h1> <%= UserMaintenanceServices.numberOfActiveUsers()%> </h1>
                            </li>
                            <li class="sky">
                                <h4>Registered Users</h4>
                                <h1> <%= UserMaintenanceServices.numberOfRegisteredUsers()%> </h1>
                            </li>
                            <li class="orange">
                                <h4>Guest Users</h4>
                                <h1> <%= UserMaintenanceServices.numberOfGuestUsers()%></h1>
                            </li>
                        </ul>

                        <ul class="lst-2">
                            <li class="skbl"> <h4 style="color:white">Likes</h4><i class="fa fa-thumbs-o-up" aria-hidden="true"> <%= UserMaintenanceServices.numberOfLikes()%></i></li>
                            <li class="pnk"><h4 style="color:white">Dislikes</h4> <i class="fa fa-thumbs-o-down" aria-hidden="true"> <%= UserMaintenanceServices.numberOfDislikes()%></i></li>
                            <li class="skb2"><a href="Comments.jsp"><h4 style="color:white">Comments</h4></a> <i class="fa fa-comments-o" aria-hidden="true"></i> </li>
                        </ul>
                    </div>
                </div>
            </div>
